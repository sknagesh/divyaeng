...
$query="SELECT Tool_Part_NO,Tool_Desc,Tool_Dia,Ope_Tool_OH,Ope_Tool_Desc,Holder_Description FROM Ope_Tool AS ot  
...
while($row=mysql_fetch_assoc($res))
{
	...
	print("<tr><td>$row[Tool_Part_NO] $row[Tool_Desc]</td><td>$row[Ope_Tool_Desc]</td><td>$row[Holder_Description]</td><td>$row[Ope_Tool_OH]</td></tr>");
