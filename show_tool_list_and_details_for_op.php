...
print("</table>");
$query="SELECT Ope_Tool_ID,t.Tool_Part_NO,t.Tool_Desc,tt.Tool_Part_NO as tpn2,tt.Tool_Desc as tde2,Ope_Insert_ID,Insert_Part_NO,Insert_Desc,t.Tool_Dia,Tool_ID_1,Tool_ID_2,Ope_Tool_OH,Ope_Tool_Desc,Holder_Desc FROM Ope_Tool AS ot 
