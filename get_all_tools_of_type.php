...
if($ttypeid!='')
{
	$ttypeid=" AND Tool_Type_ID='$ttypeid' ";
}
...
$query="SELECT Brand_Description,Tool_Part_NO,Tool_Desc,Tool_Dia,Shank_Dia,
		...
		Tool_Coating,Qty_New,Qty_New_SF FROM Tool as t
...
{
print("<tr><td>$row[Brand_Description]</td><td>$row[Tool_Part_NO]</td><td>$row[Tool_Desc]</td>
