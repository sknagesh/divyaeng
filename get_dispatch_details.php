...
$query="SELECT *,DATE_FORMAT(Date,'%d/%m/%Y')as ddt,Drawing_NO,Drawing_Rev,
		Component_Name,Mode_Of_Despatch,DC_NO FROM MO_Drg_Qty as modq
		INNER JOIN Material_Outward as mo ON mo.Material_Outward_ID=modq.Material_Outward_ID
...
//print($query);
		  ...
		  print("<tr class=\"t\" ><th>DC No</th><th>Dispatch Date</th><th>Component Name</th>
		  						<th>Drawing NO</th><th>Dispatch Qty</th><th>Dispatch Mode</th></tr>");
...
//		  		$bno=$row['Mfg_Batch_NO'];
		  ...
		  print("<tr><td>$row[DC_NO]</td><td>$ddt</td><td>$compname</td><td>$drgno</td><td align=\"center\">$dqty</td><td>$dmode</td></tr>");
